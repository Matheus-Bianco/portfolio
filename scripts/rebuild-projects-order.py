...
CARDS = [
    ...
    ("project8", "03", "fa-chart-area", "assets/images/projects/project8/1.png", "Painel IDEB Sergipe",
     "SED Sergipe / FGV · Nordeste", "Painel de Indicadores Educacionais — IDEB & Censo",
     "Comparações de IDEB, SAEB e aprovação de Sergipe frente ao Nordeste e ao Brasil.",
     ["Python", "Dados INEP", "Nordeste", "Pipeline de Dados"]),
    ...
    ("project1", "07", "fa-exclamation-triangle", "assets/images/projects/project1/1.jpg", "Indicadores de risco",
     "SED Sergipe / FGV · Nordeste", "Plataforma de Indicadores de Risco Educacional",
    ...
    ("project3", "10", "fa-tachometer-alt", "assets/images/projects/project3/1.jpg", "Sistema GA/SE",
     "SED Sergipe / FGV · Nordeste", "Sistema de Acompanhamento de Dados GA/SE",
    ...
    ("project4", "11", "fa-clipboard-check", "assets/images/projects/project4/1.jpg", "Avaliações diagnósticas",
     "SED Sergipe / FGV · Nordeste", "Sistema de Gestão de Avaliações Diagnósticas",
    ...
    ("project6", "12", "fa-chart-line", "assets/images/projects/project6/1.jpg", "Risco temporal",
     "SED Sergipe / FGV · Nordeste", "Sistema de Monitoramento Temporal de Risco",
    ...
    ("project7", "13", "fa-sort-amount-down", "assets/images/projects/project7/1.jpg", "Priorização SAEB",
     "SED Sergipe / FGV · Nordeste", "Sistema de Priorização de Escolas para o SAEB",
